...
- **Object Index**: Index mapping object IDs to spatial locations (optional when single-chunk and `object_index_convention: "identity"`; required when multiple spatial chunks)
